...
dt = (tE - 0.0) / Np #dla dt = 0.004 zaczyna falować energia, dla dt = 0.04 zaczyna falować moment pędu
dt2 = dt * dt
...
pyplot.plot(tarr, enearr, 'r', tarr, momarr, 'b')
pyplot.legend(['Energia', 'Moment pędu'])
pyplot.xlabel('Czas')
pyplot.ylabel('Wartość')
pyplot.title('Wartość energii i momentu pędu w czasie')
pyplot.show()
